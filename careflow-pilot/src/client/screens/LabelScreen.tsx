...
export function LabelScreen(): ReactElement {
  ...
  const guidance = checking
    ...
    : pickListUnavailable
      ? "ไม่สามารถยืนยันรายการจัดยาปัจจุบัน จึงยังพิมพ์ไม่ได้"
      : stale
        ? "ข้อมูลฉลากไม่ตรงกับรายการปัจจุบัน จึงไม่สามารถพิมพ์ได้"
        : requested
          ? "บันทึกคำขอพิมพ์แล้ว และเปิดหน้าต่างพิมพ์ให้ตรวจสอบ"
          : "บันทึกคำขอพิมพ์ก่อนเปิดหน้าต่างพิมพ์; การบันทึกไม่ยืนยันว่าพิมพ์ทางกายภาพสำเร็จ";
  const printHint = checking
    ? "กำลังตรวจสอบข้อมูลปัจจุบัน…"
    : pickListUnavailable
