...
beforeEach(() => server.resetHandlers(
  ...
  http.get("/api/dashboard/today", () => HttpResponse.json({ data: { waiting: 0, consulting: 1, awaitingOrderRevision: 0, awaitingPreparation: 0, preparing: 0, awaitingRelease: 0, awaitingHandoff: 0, awaitingCharge: 0, awaitingPayment: 0, readyToClose: 0, updatedAt: "2026-08-03T01:00:00.000Z" } })),
));
...
describe("Doctor consultation authoring", () => {
  ...
  it.each([
    ...
    ["AWAITING_CHARGE", "ไปหน้าชำระเงิน", "/checkout/visit-42", "ชำระเงิน"],
