...
- Expected: เห็นข้อความ `บันทึกคำขอพิมพ์แล้ว`; ฉลากแสดง `[DEMO] ยาทดสอบชนิด A` จำนวน 8 เม็ดและวิธีใช้ที่กำหนด
- Actual: บันทึกสิ่งที่เห็นระหว่าง UAT
- Result: [ ] PASS  [ ] FAIL  [ ] BLOCKED
- เวลา:
- หมายเหตุ UX:
...
- Expected: ยืนยัน `CF-DEMO-001` สำเร็จครบสองรายการ และ Visit ยังเป็น `PREPARING`
- Actual: บันทึกสิ่งที่เห็นระหว่าง UAT
- Result: [ ] PASS  [ ] FAIL  [ ] BLOCKED
- เวลา:
- หมายเหตุ UX:
...
- Expected: เห็นข้อความ `บันทึกคำขอพิมพ์แล้ว` และ Visit ยังเป็น `PREPARING`
- Actual: บันทึกสิ่งที่เห็นระหว่าง UAT
- Result: [ ] PASS  [ ] FAIL  [ ] BLOCKED
- เวลา:
- หมายเหตุ UX:
...
- Expected: ยืนยัน `CF-DEMO-001` สำเร็จ และ Visit เป็น `AWAITING_RELEASE`
- Actual: บันทึกสิ่งที่เห็นระหว่าง UAT
- Result: [ ] PASS  [ ] FAIL  [ ] BLOCKED
- เวลา:
- หมายเหตุ UX:
...
- Expected: เห็นข้อความ `บันทึกคำขอพิมพ์แล้ว` สำหรับฉลากปัจจุบันรอบใหม่
- Actual: บันทึกสิ่งที่เห็นระหว่าง UAT
- Result: [ ] PASS  [ ] FAIL  [ ] BLOCKED
- เวลา:
- หมายเหตุ UX:
...
- Expected: ใน `คิวผู้ป่วย` ของ Assistant ไม่มีคำสั่ง `เริ่มการตรวจ`; Assistant เห็นเฉพาะการติดตามคิวและคำสั่งที่อนุญาต
- Actual: บันทึกสิ่งที่เห็นระหว่าง UAT
- Result: [ ] PASS  [ ] FAIL  [ ] BLOCKED
- เวลา:
- หมายเหตุ UX:
...
- Expected: Assistant ไม่เห็น `ยืนยัน PromptPay`, `ยกเว้นเต็มจำนวน`, `ปิด Visit`, หรือ `เปิดบัตร OPD`; เห็นข้อความรอแพทย์หรือคำสั่งที่ทำได้เท่านั้น
- Actual: บันทึกสิ่งที่เห็นระหว่าง UAT
- Result: [ ] PASS  [ ] FAIL  [ ] BLOCKED
- เวลา:
- หมายเหตุ UX:
...
### ROLE-03 — Doctor เห็นคำสั่งตามสถานะของ Visit
- Expected: Doctor เห็น `เริ่มการตรวจ`, `ยืนยันยอดเพื่อรับชำระ`, `ยืนยัน PromptPay`, `ยกเว้นเต็มจำนวน`, และ `ปิด Visit` เมื่อ Visit อยู่ในสถานะที่ถูกต้อง
- Actual: บันทึกสิ่งที่เห็นระหว่าง UAT
- Result: [ ] PASS  [ ] FAIL  [ ] BLOCKED
- เวลา:
- หมายเหตุ UX:
